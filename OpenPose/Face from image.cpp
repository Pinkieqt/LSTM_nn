...
// Producer/media/pinkie/A6FC43F0FC43B977/AData/OpenPose_images
DEFINE_string(image_path, "examples/media/img1.jpg",
              "Process an image. Read all standard formats (jpg, png, bmp, etc.).");
//DEFINE_string(image_path, "/media/pinkie/A6FC43F0FC43B977/AData/OpenPose_images/iphone_new/img11100.jpg",
//              "Process an image. Read all standard formats (jpg, png, bmp, etc.).");
// Display
...
int tutorialApiCpp()
{
    try
    {
        ...
        const std::vector<op::Rectangle<float>> faceRectangles{
            op::Rectangle<float>{50.00f, 50.00f, 700.00f, 700.00f} //iphone // Face of person 0
        };
